...
DATASET_PATH = "https://huggingface.co/datasets/yadavgovind/Bank-Customer-Churn/resolve/main/bank_customer_churn.csv"
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="Bank-Customer-Churn/bank-customer-churn",
        repo_type="dataset",
    )
